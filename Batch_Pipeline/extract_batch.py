...
def push_file(filename):
        ...
        to_bucket = storage_client.get_bucket("dataflow landing bucket") # $DEVSHELL_PROJECT_ID-dataflow-bucket-loading
        to_table = to_bucket.blob('DataFlow.csv')
        to_table.upload_from_filename('DataFlow.csv')
...
def data_extract():
    ...
    mydata.to_csv('DataFlow.csv', index=False, sep = ';')

    push_file('DataFlow.csv')
